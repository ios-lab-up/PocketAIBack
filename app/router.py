...
try:
    vectorizer = joblib.load("/app/data/models/vectorizer.pkl")
    classifier = joblib.load("/app/data/models/intent_classifier.pkl")
    label_encoder = joblib.load("/app/data/models/label_encoder.pkl")
